...
<body>
	...
	<h2>Edit Data QC Input</h2>
	<form action="cari3.php" method="post">
		...
		<?php
			...
			while ($row=$result2 -> fetch_object()) {	
				echo "<tr>
						...
						<td>
							<!--<a href="../library/proses_hapus.php?idinput=<?php echo $row->id_input; ?>">Hapus</a>-->
							<a href="../library/proses_hapus.php?idinput=<?php echo $row->id_input; ?>"><button onclick="return confirm('Apakah Anda yakin akan menghapus data ini?')">HAPUS</button></a>
						</td>				
					</tr>
					<?php $no ++;
			 } ;
